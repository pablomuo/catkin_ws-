...
###################################
                ...
                weight.saving_weights("agent",contador,agents.action,agents.learning.q_model.get_weights(),agents.last_state)

                if (contador%200==0) and (agents.step>0):
                    agents.learning.save_model_to_check(rank,contador)

                state_send, _ = agents.last_state
                state_pa = [state_send, agents.learning.Pa, contador]
